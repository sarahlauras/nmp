...
object TeamData {
    var teamData = arrayOf(
        ...
        TeamBank(3, 1, "Team Phantom", "Tim dengan fokus pada kreativitas dan permainan taktis.","R.drawable.team4",4,""),
        TeamBank(4, 2, "Team Eclipse", "Tim baru dengan sinergi kuat antara pemain muda.","R.drawable.team5",5,""),
        TeamBank(5, 2, "Team Nexus", "Tim juara lokal dengan ambisi untuk bersaing di tingkat internasional.","R.drawable.team6",6,"")
    )
}