...
object GameData {
    var gameData = arrayOf(
        GameArray("Valorant", "VALORANT adalah game tembak-menembak taktis tempat kamu dan 4 rekan tim berhadapan dengan 5 Agen lain dalam baku tembak berbekal satu nyawa per ronde untuk jadi yang pertama memenangkan 13 ronde! Menarik, 'kan? Namun VALORANT bukan hanya tentang keahlian senjata. Kamu harus memanfaatkan kemampuan unik, strategi, dan kecerdikan untuk mengecoh lawan (sekaligus tampil lebih gaya), sambil menempatkan atau menjinakkan Spike yang hampir meledak.",
            R.drawable.valorant),
